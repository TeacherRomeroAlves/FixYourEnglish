...
if (unscrambleGame) {
  const sentencePool = [
    { level: "Advanced", words: ["The", "broken", "window", "was", "replaced", "by", "a", "local", "builder"], punctuation: "." },
    { level: "Advanced", words: ["Why", "are", "visitors", "required", "to", "show", "their", "identity", "cards"], punctuation: "?" },
    { level: "Expert", words: ["The", "missing", "painting", "has", "been", "recovered", "by", "a", "team", "of", "detectives"], punctuation: "." },
    { level: "Expert", words: ["Why", "should", "the", "equipment", "have", "been", "inspected", "before", "the", "event", "started"], punctuation: "?" },
    { level: "Starter", words: ["My", "sister", "likes", "orange", "juice"], punctuation: "." },
    { level: "Starter", words: ["The", "dog", "is", "under", "the", "table"], punctuation: "." },
    { level: "Starter", words: ["This", "jacket", "is", "too", "small"], punctuation: "." },
    { level: "Starter", words: ["Your", "shoes", "are", "not", "clean"], punctuation: "." },
    { level: "Starter", words: ["These", "flowers", "need", "some", "water"], punctuation: "." },
    { level: "Easy", words: ["Does", "your", "father", "speak", "Italian"], punctuation: "?" },
    { level: "Easy", words: ["The", "library", "does", "not", "open", "on", "Sundays"], punctuation: "." },
    { level: "Easy", words: ["Are", "these", "sandwiches", "for", "the", "children"], punctuation: "?" },
    { level: "Easy", words: ["My", "phone", "does", "not", "have", "a", "camera"], punctuation: "." },
    { level: "Easy", words: ["Can", "you", "spell", "your", "last", "name"], punctuation: "?" },
    { level: "Medium", words: ["How", "much", "did", "your", "new", "bicycle", "cost"], punctuation: "?" },
    { level: "Medium", words: ["Which", "bus", "goes", "to", "the", "city", "center"], punctuation: "?" },
    { level: "Medium", words: ["My", "brother", "did", "not", "pass", "his", "driving", "test"], punctuation: "." },
    { level: "Medium", words: ["What", "are", "you", "looking", "for", "in", "that", "drawer"], punctuation: "?" },
    { level: "Medium", words: ["This", "soup", "is", "too", "hot", "to", "eat"], punctuation: "." },
    { level: "Challenging", words: ["Have", "you", "ever", "seen", "a", "whale", "in", "the", "ocean"], punctuation: "?" },
    { level: "Challenging", words: ["How", "long", "have", "you", "known", "your", "best", "friend"], punctuation: "?" },
    { level: "Challenging", words: ["The", "mechanic", "has", "not", "finished", "repairing", "my", "car"], punctuation: "." },
    { level: "Challenging", words: ["Which", "language", "would", "you", "like", "to", "learn", "next"], punctuation: "?" },
    { level: "Challenging", words: ["My", "cousin", "is", "afraid", "of", "swimming", "in", "deep", "water"], punctuation: "." },
    { level: "Advanced", words: ["Could", "you", "tell", "me", "where", "the", "nearest", "pharmacy", "is"], punctuation: "?" },
    { level: "Advanced", words: ["This", "suitcase", "is", "not", "large", "enough", "to", "hold", "everything"], punctuation: "." },
    { level: "Advanced", words: ["How", "long", "have", "you", "been", "waiting", "for", "the", "bus"], punctuation: "?" },
    { level: "Advanced", words: ["The", "museum", "was", "closed", "because", "the", "roof", "needed", "repairs"], punctuation: "." },
    { level: "Advanced", words: ["What", "would", "you", "do", "if", "you", "lost", "your", "passport"], punctuation: "?" },
    { level: "Expert", words: ["Do", "you", "know", "whether", "the", "entrance", "fee", "includes", "a", "guided", "tour"], punctuation: "?" },
    { level: "Expert", words: ["The", "hotel", "refused", "to", "refund", "the", "deposit", "despite", "receiving", "my", "cancellation"], punctuation: "." },
    { level: "Expert", words: ["How", "would", "you", "have", "reacted", "if", "you", "had", "missed", "your", "flight"], punctuation: "?" },
    { level: "Expert", words: ["The", "manager", "insisted", "on", "checking", "the", "equipment", "before", "allowing", "anyone", "inside"], punctuation: "." },
    { level: "Expert", words: ["What", "could", "we", "have", "done", "to", "prevent", "the", "problem", "from", "happening"], punctuation: "?" },
